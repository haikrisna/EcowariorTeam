...
<body>
  	...
  	<div class="pesanan-dalam-proses-vendor">
    		...
    		<div class="map-maker-sekaran-50229-gun-parent">
      			...
      			<div class="rectangle-parent1" id="groupContainer6">
        				<div class="rectangle-div">
        				</div>
        				<b class="selesaikan">Selesaikan</b>
      			</div>
      			<div class="rectangle-parent2" id="groupContainer7">
        				<div class="group-child1">
        				</div>
        				<div class="input-berat">Input Berat</div>
      			</div>
      			<div class="rectangle-parent3" id="groupContainer8">
        				<div class="group-child2">
        				</div>
        				<div class="pantau-proses">Pantau Proses</div>
      			</div>
  	...
  	<div id="logoutConfirmContainer" class="popup-overlay" style="display:none">
    		...
    		<div class="logout-confirm">
      			...
      			<div class="rectangle-parent4" id="popupgroupContainer">
        				<div class="group-child5">
        				</div>
        				<div class="yes">Yes</div>
      			</div>
      			<div class="rectangle-parent5" id="popupgroupContainer1">
  	...
  	<script>
    		...
    		var pesananMasukText = document.getElementById("pesananMasukText");
    		if(pesananMasukText) {
      			pesananMasukText.addEventListener("click", function (e) {
        				// Add your code here
      			});
    		}
